                ...
                <form className='form__content'>
                    <ul className='form__sections'>
                        <li className='form__section'>
                            ...
                            <input className='form__input form__input_type_email' id='email-login-input' type='email' name='email' minLength='2' maxLength='40' placeholder="Электронная почта" required />
                            <p className='form__input-error'/>
                        </li>
                        <li className='form__section'>
                            <label className='form__input-title' htmlFor='password-login-input'>Пароль</label>
                            <input className='form__input form__input_type_password' id='password-login-input' type='password' name='password' minLength='8' maxLength='40' placeholder="Пароль" required/>
                            <p className='form__input-error'/>
                        </li>
                    </ul>
